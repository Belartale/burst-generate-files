...
export const defineMarkerAndAddMarkerTemplate = ({ settingsMarker, dataRedFile }: types.DefineMarkerAndAddMarkerTemplate) => {
    const newDataRedFile: string = dataRedFile
        .split(/\r?\n/)
        .map((line: string) => {
